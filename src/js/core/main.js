/* =========================================================================
   MAIN.JS - Nucleul aplicatiei
   
   CONTINUT:
   1. Custom Dialog - Inlocuieste alert/confirm/prompt native
   2. Dark Mode Toggle - Comutare tema dark/light
   3. Navbar - Ascundere/afisare la scroll
   4. Hamburger Menu - Meniu mobil
   5. Scroll Animations - Animatii la scroll (IntersectionObserver)
   6. Boot Screen - Ecran de incarcare Windows-style
   7. Particle Background - Fundal animat cu particule
   ========================================================================= */
