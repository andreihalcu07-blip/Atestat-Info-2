# Download media used by history chapters into src/assets/images/history/
# Run this from the repository root or from the src/html/pages/history folder.

$target = Join-Path -Path $PSScriptRoot -ChildPath "..\..\..\assets\images\history"
