...
(function () {
    ...
    const bootImagePath = currentVersion
        ? `/src/images/windows/${currentVersion}/boot.jpg`
        : '/src/images/windows/boot.jpg';
    ...
    function createBootScreen() {
        ...
        if (currentVersion === 'win95' || currentVersion === 'win98') {
            ...
            bootContent = `
                <img class="boot-bg-image" src="${bootImagePath}" alt="" style="display:block;width:100%;height:100%;object-fit:cover;">
